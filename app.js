...
async function renderAboutHim(){
  ...
  if(state.aboutPage==='age'){
    ...
    panel=`<section class="visual-panel age-panel">
      ...
      <div class="figure-wrap visual-photo-wrap age-photo-wrap"><img id="agePortrait" class="visual-photo age-photo" src="assets/age-${ageBand}.jpg?v=69" alt=""></div>
    ...
    panel=`<section class="visual-panel body-panel-v3">
      <div class="body-visual-grid">
        ...
        <div class="body-center">
          ...
          <div class="figure-wrap body-figure-wrap visual-photo-wrap"><img id="bodyPortrait" class="visual-photo body-photo" src="assets/body-${build}.jpg?v=69" alt=""></div>
        </div>
      </div>
    ...
    panel=`<section class="visual-panel type-panel-v3">
      ...
      <div class="type-wheel" id="typeWheel">
        ...
        <div class="wheel-face ${typeNow.key}" id="wheelFace"><img id="typePortrait" class="type-photo" src="assets/type-${({twink:"twink",twonk:"twonk",otter:"otter","otter-daddy":"average",daddy:"daddy","daddy-bear":"bear",bear:"bear","young-bear":"bear"}[typeNow.key]||"average")}.jpg?v=69" alt=""></div>
  ...
  app.innerHTML=`<main class="about-visual">
    ...
    <div class="about-symbols persistent-symbols">
      <button class="about-symbol art-symbol" data-subopen="egg"><img src="assets/detail-eggplant.png?v=69" alt=""></button>
      <button class="about-symbol art-symbol" data-subopen="peach"><img src="assets/detail-peach.png?v=69" alt=""></button>
      <button class="about-symbol art-symbol" data-subopen="drop"><img src="assets/detail-drops.png?v=69" alt=""></button>
    </div>
  </main>`;
  ...
  if(state.aboutPage==='age'){
    ...
    const paintAge=()=>{
      ...
      if(fig){fig.src=`assets/age-${band}.jpg?v=69`;fig.style.filter='';fig.style.transform='scale(1)'}
    };
    ...
    document.querySelectorAll('[data-age-band]').forEach(b=>b.onclick=async()=>{
      p.about.ageExact='';p.about.ageBand=b.dataset.ageBand;v.textContent=ageBandLabel(b.dataset.ageBand);u.textContent='';document.getElementById('agePortrait').src=`assets/age-${b.dataset.ageBand}.jpg?v=69`;
  ...
  if(state.aboutPage==='body'){
    ...
    document.querySelectorAll('[data-build]').forEach(b=>b.onclick=async()=>{
      p.about.build=[b.dataset.build];p.about.buildVisual=b.dataset.build;document.getElementById('buildSummary').textContent=b.textContent;document.getElementById('bodyPortrait').src=`assets/body-${b.dataset.build}.jpg?v=69`;
  ...
  if(state.aboutPage==='type'){
    ...
    const paint=deg=>{
      ...
      if(im){const map={twink:'twink',twonk:'twonk',otter:'otter','otter-daddy':'average',daddy:'daddy','daddy-bear':'bear',bear:'bear','young-bear':'bear'};im.src=`assets/type-${map[typeNow.key]||'average'}.jpg?v=69`;}
    };
    const point=e=>{
...
async function renderPenis(){
  ...
  app.innerHTML=`<main class="private-detail-screen compact-choice-screen penis-screen">
    ...
    <nav class="private-tabs">
      <button class="on" data-go-private="penis"><img src="assets/detail-eggplant.png?v=69" alt=""></button>
      <button class="" data-go-private="peach"><img src="assets/detail-peach.png?v=69" alt=""></button>
      <button class="" data-go-private="drops"><img src="assets/detail-drops.png?v=69" alt=""></button>
    </nav>
...
async function renderPeach(){
  ...
  app.innerHTML=`<main class="private-detail-screen compact-choice-screen">
    <div class="about-top compact-detail-top"><button class="about-back" id="backPeach">‹</button><div></div><span></span></div><nav class="private-tabs">
      <button class="" data-go-private="penis"><img src="assets/detail-eggplant.png?v=69" alt=""></button>
      <button class="on" data-go-private="peach"><img src="assets/detail-peach.png?v=69" alt=""></button>
      <button class="" data-go-private="drops"><img src="assets/detail-drops.png?v=69" alt=""></button>
    </nav>
...
async function renderDrops(){
  ...
  app.innerHTML=`<main class="private-detail-screen detail-natural drops-screen">
    <div class="about-top compact-detail-top"><button class="about-back" id="backDrops">‹</button><div></div><span></span></div><nav class="private-tabs">
      <button class="" data-go-private="penis"><img src="assets/detail-eggplant.png?v=69" alt=""></button>
      <button class="" data-go-private="peach"><img src="assets/detail-peach.png?v=69" alt=""></button>
      <button class="on" data-go-private="drops"><img src="assets/detail-drops.png?v=69" alt=""></button>
    </nav>
...
(async()=>{
  ...
  if('serviceWorker' in navigator){
    try{
      const reg=await navigator.serviceWorker.register('./sw.js?v=6.9');
      await reg.update();
